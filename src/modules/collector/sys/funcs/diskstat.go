...
import (
	...
	"github.com/didi/nightingale/src/modules/collector/tools/host"
...
func DiskIOMetrics() (L []*dataobj.MetricValue) {
	...
	for _, ds := range dsList {
		...
		L = append(L, core.CounterValue("disk.io.read_requests", ds.ReadCount, device))
		L = append(L, core.CounterValue("disk.io.read_merged", ds.MergedReadCount, device))
		L = append(L, core.CounterValue("disk.io.read_bytes", ds.ReadBytes, device))
		L = append(L, core.CounterValue("disk.io.read_time", ds.ReadTime, device))
		L = append(L, core.CounterValue("disk.io.write_requests", ds.WriteCount, device))
		L = append(L, core.CounterValue("disk.io.write_merged", ds.MergedWriteCount, device))
		L = append(L, core.CounterValue("disk.io.write_bytes", ds.WriteBytes, device))
		L = append(L, core.CounterValue("disk.io.write_time", ds.WriteTime, device))
		L = append(L, core.CounterValue("disk.io.ios_in_progress", ds.IopsInProgress, device))
		L = append(L, core.CounterValue("disk.io.iotime", ds.IoTime, device))
	}
	return
}
